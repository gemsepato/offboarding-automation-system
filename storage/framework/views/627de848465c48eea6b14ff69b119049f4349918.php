...
<link href="<?php echo e(asset('/assets/css/paper-bootstrap-wizard.css')); ?>" rel="stylesheet" />
                    ...
                    <div class="card wizard-card" data-color="blue" id="wizardProfile">
                        <form id="myForm" method="post">
                            ...
                            <div class="wizard-header text-right">
                                <?php if(Auth()->user()->application->status != ''): ?>
                                    <span class="wizard-title font-weight-bold">STATUS: <span class="<?php if(Auth()->user()->application->status == 'PENDING'): ?> text-warning <?php elseif(Auth()->user()->application->status == 'APPROVED'): ?> text-success <?php elseif(Auth()->user()->application->status == 'COMPLETED'): ?>  text-info <?php endif; ?>"><?php echo e(Auth()->user()->application->status ?? ''); ?></span></span>
                                <?php endif; ?>
                            </div>
                            <div class="wizard-navigation">
                                ...
                                <ul>
                                    ...
                                    <li class="<?php echo e(Auth()->user()->application->status == 'APPROVED' ? 'active':''); ?>">
                                        <a href="#step2" data-toggle="tab"  <?php echo e(Auth()->user()->application->status == 'PENDING' || Auth()->user()->application->status == '' ? 'style=pointer-events:none':''); ?>>
                                            <div class="icon-circle">
                                                <i class="ti-arrow-right"></i>
                                            </div>
                                            STEP 2
                                    ...
                                    <li class="<?php echo e(Auth()->user()->application->status == 'COMPLETED' ? 'active':''); ?>">
                                        <a href="#step3" data-toggle="tab" <?php echo e(Auth()->user()->application->status == 'PENDING' || Auth()->user()->application->status == '' ? 'style=pointer-events:none':''); ?>>
                                            <div class="icon-circle">
                                                <i class="ti-arrow-right"></i>
                                            </div>
                                            STEP 3
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="step1">
                                    ...
                                    <h6 class="text-center text-success font-weight-bold">
                                        <?php if(Auth()->user()->application->status == 'PENDING'): ?> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="name" name="name" type="text" class="form-control" placeholder="Alexis C Bianzon" value="<?php echo e(Auth()->user()->application->name ?? ''); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="school" name="school" type="text" class="form-control" placeholder="Manuel S Enverga University Foundation" value="<?php echo e(Auth()->user()->application->school ?? ''); ?>">
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="picture-container">
                                                <div class="form-group">
                                                    ...
                                                    <div class="picture">
                                                        <img src="<?php if(Auth()->user()->application->image != ''): ?> /assets/applicant_picture/<?php echo e(Auth()->user()->application->image); ?> <?php else: ?> <?php echo e(asset('/assets/images/default-avatar.jpg')); ?>  <?php endif; ?> " class="picture-src" id="wizardPicturePreview" title="" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="course" name="course" type="text" class="form-control" placeholder="BSBA/ Marketing" value="<?php echo e(Auth()->user()->application->course ?? ''); ?>" />
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="contact_number" name="contact_number" type="number" class="form-control" placeholder="09197075776" value="<?php echo e(Auth()->user()->application->contact_number ?? ''); ?>" />
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="birth_date" name="birth_date" type="date" class="form-control" value="<?php echo e(Auth()->user()->application->birth_date ?? ''); ?>" />
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="address" name="address" type="text" class="form-control" placeholder="Pag-asa/Ibabang-Dupay/Lucena City" value="<?php echo e(Auth()->user()->application->address ?? ''); ?>" />
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="application_id" name="application_id" type="text" class="form-control" value="<?php echo e(Auth()->user()->application->application_id ?? ''); ?>" />
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" type="email" class="form-control" value="<?php echo e(Auth()->user()->email ?? ''); ?>" placeholder="Alexisbianzon18@gmail.com" />
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="student_advisor" name="student_advisor" type="text" class="form-control" placeholder="Flormando Baldovino" value="<?php echo e(Auth()->user()->application->student_advisor ?? ''); ?>" />
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="advisor_email" name="advisor_email" type="email" class="form-control" value="<?php echo e(Auth()->user()->application->advisor_email ?? ''); ?>" />
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="required_hours" name="required_hours" type="text" class="form-control" value="<?php echo e(Auth()->user()->application->required_hours ?? ''); ?>" placeholder="600" />
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="starting_date" name="starting_date" type="date" class="form-control" value="<?php echo e(Auth()->user()->application->starting_date ?? ''); ?>"/>
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="schedule" name="schedule" type="text" class="form-control" value="<?php echo e(Auth()->user()->application->schedule ?? ''); ?>" placeholder="MTWTTHF/8am to 5 pm" />
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="advance_coc" id="advance_coc" class="form-control">
                                                    <option value="">...</option>
                                                    <option value="YES" <?php echo e(Auth()->user()->application->advance_coc == 'YES' ? 'selected':''); ?>>YES</option>
                                                    <option value="NO" <?php echo e(Auth()->user()->application->advance_coc == 'NO' ? 'selected':''); ?>>NO</option>
                                                </select>
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="ending_date" name="ending_date" type="date" class="form-control" value="<?php echo e(Auth()->user()->application->ending_date ?? ''); ?>"  />
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-check ml-4">
                                                <input type="checkbox" class="form-check-input" <?php echo e(Auth()->user()->application->consent == '1' ? 'checked':''); ?> name="consent" id="consent">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="company_name" name="company_name" type="text" class="form-control" value="<?php echo e(Auth()->user()->application->company_name ?? ''); ?>">
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="company_address" name="company_address" type="text" class="form-control" value="<?php echo e(Auth()->user()->application->company_address ?? ''); ?>">
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="supervisor_name" name="supervisor_name" type="text" class="form-control" value="<?php echo e(Auth()->user()->application->supervisor_name ?? ''); ?>">
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="supervisor_email_address" name="supervisor_email_address" type="email" class="form-control" value="<?php echo e(Auth()->user()->application->supervisor_email_address ?? ''); ?>">
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="supervisor_contact_number" name="supervisor_contact_number" type="number" class="form-control" value="<?php echo e(Auth()->user()->application->supervisor_contact_number ?? ''); ?>">
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="current_job_title" id="current_job_title" class="form-control" placeholder=" Brief Description "><?php echo e(Auth()->user()->application->current_job_title ?? ''); ?></textarea>
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-12">
                                            <p class="text-justify" style="font-size: 18px;">I  <b><?php echo e(Auth()->user()->application->name); ?></b> have read the Internship Handbook. I have discussed each one of the internship requirements with my Academic Advisor Brylle Estrada and MCC, Anafara and Visvis corporation UIP Heads.</p>
                                        </div>

                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist1" id="checklist1" <?php echo e(Auth()->user()->application->checklist1 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist2" id="checklist2" <?php echo e(Auth()->user()->application->checklist2 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist3" id="checklist3" <?php echo e(Auth()->user()->application->checklist3 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist4" id="checklist4" <?php echo e(Auth()->user()->application->checklist4 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist5" id="checklist5" <?php echo e(Auth()->user()->application->checklist5 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist6" id="checklist6" <?php echo e(Auth()->user()->application->checklist6 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist7" id="checklist7" <?php echo e(Auth()->user()->application->checklist7 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist8" id="checklist8" <?php echo e(Auth()->user()->application->checklist8 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check ml-4">
                                                <input type="checkbox" class="form-check-input" name="checklist9" id="checklist9" <?php echo e(Auth()->user()->application->checklist9 == '1' ? 'checked':''); ?>>
                                        ...
                                        <div class="col-md-12 mt-5 row">
                                            ...
                                            <div class="col-6 text-center">
                                                ...
                                                <h6>
                                                    <?php echo e(Auth()->user()->application->name); ?>
                                            ...
                                            <div class="col-6 text-center">
                                                <h6>
                                                    <?php echo e(Auth()->user()->application->created_at->format('M j , Y ')); ?>
                                ...
                                <div class="tab-pane <?php echo e(Auth()->user()->application->status == 'APPROVED' ? 'active':''); ?>" id="step2">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p class="text-justify font-weight-bold" style="font-size: 18px;">Please download the attached <a href="/assets/attach_file/<?php echo e(Auth()->user()->application->admin_attach_file ?? ''); ?>" target="_blank">file</a> and upload it to your google drive. Send the link of your drive to our partner shop below. </p>
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <button id="receive_status" class="<?php echo e(Auth()->user()->application->receive_status == '0' ? 'btn-warning':'btn-default'); ?> btn btn-fill btn-wd"><?php echo e(Auth()->user()->application->receive_status == '0' ? 'Receive':'Received'); ?></button>
                                        </div>
                                ...
                                <div class="tab-pane <?php echo e(Auth()->user()->application->status == 'COMPLETED' ? 'active':''); ?>" id="step3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <b>Questions:</b>
                                        ...
                                        <div class="col-md-12">
                                              <div class="form-group">
                                                ...
                                                <a id="answer_link" href="/assets/applicant_answer_video/<?php echo e(Auth()->user()->application->answer_video); ?>" target="_blank"><?php echo e(Auth()->user()->application->answer_video); ?></a>
                                            </div> 
                                        </div>
                            ...
                            <div class="wizard-footer">
                                <div class="pull-right">
                                    <?php if(Auth()->user()->application->status == 'PENDING' || Auth()->user()->application->status == ''): ?>
...
<script src="<?php echo e(asset('/assets/js/paper-bootstrap-wizard.js')); ?>" type="text/javascript"></script>
...
$('#myForm').on('submit', function(event){
    ...
    var action_url = "<?php echo e(route('admin.user.offboarding.application')); ?>";
    var type = "POST";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\offboarding-updated\resources\views/user/offboarding.blade.php ENDPATH**/ ?>