        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="text-right m-2">
                    <?php if($application->status != ''): ?>
                        <span class="wizard-title font-weight-bold">STATUS: <span class="<?php if($application->status == 'PENDING'): ?> text-warning <?php elseif($application->status == 'APPROVED'): ?> text-success <?php elseif($application->status == 'COMPLETED'): ?>  text-info <?php endif; ?>"><?php echo e($application->status ?? ''); ?></span></span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($application->name ?? ''); ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label>School:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->school ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="picture-container">
                            <div class="form-group">
                                <label>Image:</label>
                                <div class="picture">
                                    <img src="/assets/applicant_picture/<?php echo e($application->image); ?>" class="picture-src" id="wizardPicturePreview" title="" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Course:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->course ?? ''); ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label>Contact Number:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->contact_number ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Birth Date:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->birth_date ?? ''); ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label>Address:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->address ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Application ID:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->application_id ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Advisor Email:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->advisor_email ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Required No. of Hours:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->required_hours ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Do you need an advance COC?</label>
                            <input type="text" class="form-control" value="<?php echo e($application->advance_coc ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Starting Date:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->starting_date ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Ending Date:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->ending_date ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Schedule:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->schedule ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->consent == '1' ? 'checked':''); ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($application->company_name ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Company Address:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->company_address ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Supervisor Name:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->supervisor_name ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Supervisor Email Address:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->supervisor_email_address ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Supervisor Contact Number:</label>
                            <input type="text" class="form-control" value="<?php echo e($application->supervisor_contact_number ?? ''); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Current Job Title:</label>
                            <textarea class="form-control" readonly><?php echo e($application->current_job_title ?? ''); ?></textarea>
                        </div> 
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Give job title(s) and description for job you hope to have after graduating.</label>
                            <textarea class="form-control" readonly><?php echo e($application->give_job_titles ?? ''); ?></textarea>
                        </div> 
                    </div>
                    <div class="col-md-12 mt-2">
                        <hr>
                    ...
                    <div class="col-md-12">
                        <p class="text-justify" style="font-size: 18px;">I  <b><?php echo e($application->name); ?></b> have read the Internship Handbook. I have discussed each one of the internship requirements with my Academic Advisor Brylle Estrada and MCC, Anafara and Visvis corporation UIP Heads.</p>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist1 == '1' ? 'checked':''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist2 == '1' ? 'checked':''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist3 == '1' ? 'checked':''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist4 == '1' ? 'checked':''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist5 == '1' ? 'checked':''); ?>>
                            <label class="form-check-label" style="font-size: 17px;">My attendance logs were checked by HR- Admin.</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist6 == '1' ? 'checked':''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist7 == '1' ? 'checked':''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox" class="form-check-input" <?php echo e($application->checklist8 == '1' ? 'checked':''); ?>>
                            <label class="form-check-label" style="font-size: 17px;">I have received an official acceptance letter.</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check ml-4">
                            <input type="checkbox"  class="form-check-input" <?php echo e($application->checklist9 == '1' ? 'checked':''); ?>>
            ...
            <div class="card-footer m-5">
                <div class="pull-right">
                  <input type='button' class='btn btn-success btn-wd font-weight-bold status'  status="<?php echo e($application->id); ?>" value='SET STATUS' />   
                </div>
                <div class="pull-left">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\offboarding-updated\resources\views/admin/applications/full_detail.blade.php ENDPATH**/ ?>