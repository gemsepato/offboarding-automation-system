                    ...
                    <table class="table" width="100%" >
                        ...
                        <tbody>
                            <?php $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $register): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <button class="btn <?php echo e($register->status == 'PENDING' ? 'btn-warning status':'btn-danger'); ?>  btn-wd btn-sm " status="<?php echo e($register->id ?? ''); ?>">
                                            <?php echo e($register->status ?? ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\offboarding-updated\resources\views/admin/registration/registration.blade.php ENDPATH**/ ?>