            ...
            <div class="col-xs-12 col-sm-6 col-md-4 mt-5">
                <div class="card">
                    <div class="card-body text-center">
                        <p><img class="rounded-circle z-depth-2" width="90" height="80" src="/assets/applicant_picture/<?php echo e($application->image); ?>" alt="card image"></p>
                        <h4 class="card-title"><?php echo e($application->name); ?></h4>
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <p class="card-text font-weight-bold">
                                        ...
                                        <?php echo e($application->contact_number); ?>

                                    </p>
                                </div>
                            </div>
                        </div>
                        <p class="card-text font-weight-bold m-3 badge <?php if($application->status == 'PENDING'): ?> badge-warning <?php elseif($application->status == 'APPROVED'): ?> badge-success <?php elseif($application->status == 'COMPLETED'): ?> badge-info <?php endif; ?> mt-2">
                            <?php echo e($application->status); ?>

                        </p>
                        <br>
                        <button class="btn btn-primary btn-sm font-weight-bold detail btn-wd" detail="<?php echo e($application->id); ?>">FULL DETAILS</button>
                        <button class="btn btn-success btn-sm font-weight-bold status btn-wd"  status="<?php echo e($application->id); ?>">SET STATUS</button>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\offboarding-updated\resources\views/admin/applications/application.blade.php ENDPATH**/ ?>