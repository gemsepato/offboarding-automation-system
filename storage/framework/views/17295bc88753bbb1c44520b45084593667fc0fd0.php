...
<div class="col-xl-12">
    <div class="row">
        <div class="col-m-10 mx-auto mt-5">
            ...
            <div class="card-grey py-4">
              <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="card-header text-center px-3 px-md-4 py-0">
                  ...
                  <p style="line-height:4;"> Welcome, Offboarding Interns!</p>
                ...
                <div class="card-body  px-4 px-md-5">
                  ...
                  <p class="text-left mt-3 color-black" style="font-size: 15px; font-weight: 500;">Do not have an account yet? <a href="/register"><b class="color-black" style="font-weight: 700">Register here</b></a></p>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.no_navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\offboarding\resources\views/auth/login.blade.php ENDPATH**/ ?>